    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tickets', to='ticketing.booking')),
            ...
            options={
                'indexes': [models.Index(fields=['status', 'event'], name='ticketing_t_status_7f4d5c_idx')],
